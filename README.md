...
* 📊 **Loot Analytics Dashboard:** A zero-dependency, 100% Vanilla JS and SVG-powered statistics dashboard. Features interactive Donut Charts for platform breakdowns, **scrollable Monthly Activity Bar Chart** (with horizontal scroll for 6+ months), and a Robinhood-style Line Chart with an interactive date scrubber to track your lifetime wealth generation.
